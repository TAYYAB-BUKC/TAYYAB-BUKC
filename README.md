...
🎯 **C# Programmer** with **5+ years of experience** in **.NET technologies** including **ASP.NET Core, MVC, and REST APIs**. Currently expanding expertise in **Vue 3** and **Azure Cloud** with a strong passion for building scalable web applications and exploring modern technologies.
...
- **Others:** REST API, Azure DevOps, Git/GitHub, Docker
